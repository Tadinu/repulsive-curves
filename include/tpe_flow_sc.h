...
public:
    ...
    double CurrentEnergy(SpatialTree* root = nullptr) const;
    double TPEnergyDirect() const;
    double TPEnergyBH(SpatialTree* root) const;
    //void FillGradientSingle(Eigen::MatrixXd& gradients, int i, int j) const;
    void FillGradientVectorDirect(Eigen::MatrixXd& gradients) const;
    void FillGradientVectorBH(SpatialTree* root, Eigen::MatrixXd& gradients) const;
    void AddAllGradients(SpatialTree* root, Eigen::MatrixXd& gradients) const;
